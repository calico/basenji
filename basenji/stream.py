...
class PredGradStream:
    ''' Interface to acquire predictions and gradients via a buffered stream
         mechanism rather than getting them all at once and using excessive memory. '''
    ...
    def __getitem__(self, i):
        ...
        return self.stream_preds[i - self.stream_start], self.stream_grads[i - self.stream_start]