...
def main():
    ...
    parser.add_option(
        ...
        default=False,
        action="store_true",
        help="Save predictions and variance arrays [Default: %default]",
    )
    parser.add_option(
        "--rc",
        dest="rc",
    ...
    parser.add_option(
        ...
        dest="targets",
        default=None,
        help="Comma-separated list of target indexes to plot [Default: %default]",
    )
    parser.add_option(
        "-v",
        dest="valid",
    ...
    if job["fourier"]:
        ...
        batcher_test = basenji.batcher.Batcher(
            test_seqs, test_targets, test_na, model.batch_size, model.target_pool
        )
    ...
    with tf.Session() as sess:
        ...
        preds, preds_var = model.predict(
            ...
            down_sample=options.down_sample,
        )
