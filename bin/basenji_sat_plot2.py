...
def main():
  ...
  for si in seq_indexes:
    ...
    if aligned_nt / options.plot_len < 0.25:
      print('WARNING: skipping sequence %d due to poor alignment %.3f' % (si, align_rate),
            file=sys.stderr)
    else:
      # read scores
      ...
      esa = expand_scores_align(scores1, scores2, seq1_1hot, seq2_1hot, seq1_align, seq2_align)
